"""Thread-safe task store: in-memory dict persisted to .saido_agent/tasks.json."""
...
# Tasks are keyed by ID, stored per session in <cwd>/.saido_agent/tasks.json
...
def _tasks_file() -> Path:
    return Path.cwd() / ".saido_agent" / "tasks.json"
