...
_SKILL_SCHEMA = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "args": {"type": "string", "description": "Arguments to pass", "default": ""},
        },
        "required": ["name"],
    },
}
...
def _skill_tool(params: dict, config: dict) -> str:
    ...
    from saido_agent.core import agent as _agent
...
def _register() -> None:
    register_tool(ToolDef(name="Skill", schema=_SKILL_SCHEMA, func=_skill_tool, read_only=False, concurrent_safe=False))
    register_tool(ToolDef(name="SkillList", schema=_SKILL_LIST_SCHEMA, func=_skill_list_tool, read_only=True, concurrent_safe=True))
